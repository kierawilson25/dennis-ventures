...
| **D2** | **The 7 copy placeholders** — home mission; About pillars ×3 (Veteran Roots, Health-First Pivot, Social Mandate); About values ×3 (Expertise, Calmness, Professionalism). Needs the founder's voice. | 🔴 **Open** — client dependency, likeliest schedule slip | Phase 2 |
